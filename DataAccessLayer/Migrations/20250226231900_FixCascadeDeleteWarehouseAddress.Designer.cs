...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250226231900_FixCascadeDeleteWarehouseAddress")]
    partial class FixCascadeDeleteWarehouseAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObject.Models.Warehouse", b =>
                {
                    ...
                    b.Property<string>("WarehousName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BusinessObject.Models.Address", b =>
                {
                    b.HasOne("BusinessObject.Models.Warehouse", "Warehouse")
                        .WithOne("Address")
                        .HasForeignKey("BusinessObject.Models.Address", "AddressId")
